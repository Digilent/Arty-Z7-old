...
entity \_xilinx_top__axi_dynclk_S00_AXI\ is
  port (
...
end \_xilinx_top__axi_dynclk_S00_AXI\;

architecture STRUCTURE of \_xilinx_top__axi_dynclk_S00_AXI\ is
  ...
  signal data5 : STD_LOGIC_VECTOR ( 13 downto 0 );
  signal data6 : STD_LOGIC_VECTOR ( 13 downto 0 );
  ...
  signal slv_reg6 : STD_LOGIC_VECTOR ( 19 downto 10 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \_xilinx_top__mmcme2_drp\ is
  port (
    I : out STD_LOGIC;
...
end \_xilinx_top__mmcme2_drp\;

architecture STRUCTURE of \_xilinx_top__mmcme2_drp\ is
  ...
  attribute SOFT_HLUTNM of \rom_do[14]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \rom_do[23]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \rom_do[24]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \rom_do[25]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \rom_do[27]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \rom_do[28]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \rom_do[29]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \rom_do[30]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \rom_do[31]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \rom_do[32]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \rom_do[33]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \rom_do[34]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \rom_do[36]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \rom_do[37]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \rom_do[38]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \state_count[0]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \state_count[3]_i_2\ : label is "soft_lutpair4";
begin
  LOCKED_O <= \^locked_o\;
...
\state_count[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => state_count(1),
      I3 => state_count(0),
      I4 => \state_count[3]_i_2_n_0\,
      I5 => current_state(1),
      O => \state_count[3]_i_1_n_0\
    );
\state_count[3]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0006"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \_xilinx_top__axi_dynclk\ is
  port (
    s00_axi_wready : out STD_LOGIC;
    s00_axi_awready : out STD_LOGIC;
    s00_axi_arready : out STD_LOGIC;
...
end \_xilinx_top__axi_dynclk\;

architecture STRUCTURE of \_xilinx_top__axi_dynclk\ is
  ...
  signal data5 : STD_LOGIC_VECTOR ( 15 downto 14 );
  signal data6 : STD_LOGIC_VECTOR ( 15 downto 14 );
  signal rom : STD_LOGIC_VECTOR ( 12 downto 0 );
  signal rom_addr : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal sen_reg : STD_LOGIC;
  signal slv_reg7 : STD_LOGIC_VECTOR ( 25 downto 3 );
  attribute box_type : string;
...
Inst_mmcme2_drp: entity work.\_xilinx_top__mmcme2_drp\
     port map (
      CLR => CLR,
      ...
      Q(4) => slv_reg7(25),
      Q(3) => slv_reg7(21),
      Q(2 downto 1) => slv_reg7(7 downto 6),
      Q(0) => slv_reg7(3),
      REF_CLK_I => REF_CLK_I,
      SR(0) => RST,
      data3(2 downto 1) => data3(14 downto 13),
      data3(0) => data3(10),
      \out\(4) => STAT_REG(0),
      ...
      \slv_reg3_reg[31]\(3 downto 2) => data5(15 downto 14),
      \slv_reg3_reg[31]\(1 downto 0) => data6(15 downto 14),
      \slv_reg4_reg[0]\ => axi_dynclk_S00_AXI_inst_n_31,
      \slv_reg4_reg[3]\ => axi_dynclk_S00_AXI_inst_n_33
    );
axi_dynclk_S00_AXI_inst: entity work.\_xilinx_top__axi_dynclk_S00_AXI\
     port map (
      D(11 downto 10) => rom(12 downto 11),
      D(9 downto 0) => rom(9 downto 0),
      Q(6) => slv_reg7(25),
      Q(5) => slv_reg7(21),
      Q(4 downto 3) => slv_reg7(7 downto 6),
      Q(2) => slv_reg7(3),
      Q(1 downto 0) => data3(14 downto 13),
      SR(0) => RST,
      \axi_rdata_reg[30]_0\(0) => data3(10),
      \axi_rdata_reg[31]_0\(3 downto 2) => data5(15 downto 14),
      \axi_rdata_reg[31]_0\(1 downto 0) => data6(15 downto 14),
      \out\(1) => STAT_REG(0),
...
entity \_xilinx_top_\ is
  ...
  attribute CHECK_LICENSE_TYPE of \_xilinx_top_\ : entity is "linux_bd_axi_dynclk_0_0,axi_dynclk,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of \_xilinx_top_\ : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of \_xilinx_top_\ : entity is "axi_dynclk,Vivado 2016.1";
end \_xilinx_top_\;
...
U0: entity work.\_xilinx_top__axi_dynclk\
     port map (
      LOCKED_O => LOCKED_O,
